...
<body>
    ...
    <nav class=" grey darken-3">
        <div class="nav-wrapper container grey darken-3">
            <a href="../components/dashboardemp.php" class="brand-logo">Online Crime Management</a>
            <ul id="nav-mobile" class="right hide-on-med-and-down">
                <li><a href="../components/emp/blogs.php">Blogs</a></li>
                <li><a href="../components/emp/createpost.php">Create Post</a></li>
                <li><a href="../components/emp/viewcomplaints.php">View Complaints</a></li>
                <li><a href="../components/emp/viewrecords.php">View Criminal Records</a></li>
    ...
    <div class="container">
    <marquee> <h3> Welcome <?php echo $_SESSION['username']; ?>  &#128526</h3></marquee>
    </div>
